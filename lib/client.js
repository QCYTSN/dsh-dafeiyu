    ...
    return React.createElement('li', { style: cardStyle, 'data-testid': 'dsh-dafeiyu-settings' },
      ...
      status === 'unavailable'
        ...
        : React.createElement(React.Fragment, null,
          ...
          React.createElement('div', { style: { borderTop: '1px solid var(--border-color, #e5e5e5)', paddingTop: 12, marginTop: 4, display: 'grid', gap: 6 } },
            React.createElement('div', { style: { fontWeight: 600, fontSize: 14 } }, '支持与贡献'),
            React.createElement('a', { href: 'https://github.com/QCYTSN/dsh-dafeiyu', target: '_blank', rel: 'noreferrer', style: { color: 'var(--accent-color, #3478f6)', fontSize: 13 } }, 'GitHub 仓库 · 给大肥鱼点个 ⭐'),
            React.createElement('a', { href: 'https://github.com/QCYTSN/dsh-dafeiyu/issues', target: '_blank', rel: 'noreferrer', style: { color: 'var(--accent-color, #3478f6)', fontSize: 13 } }, '提 Issue · 反馈问题或建议'),
            React.createElement('a', { href: 'https://www.npmjs.com/package/dsh-dafeiyu', target: '_blank', rel: 'noreferrer', style: { color: 'var(--accent-color, #3478f6)', fontSize: 13 } }, 'npm 页面 · 查看更新'),
          ),
