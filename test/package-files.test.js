...
test('package files whitelist ships the glove cursors and their license notice', async () => {
...
test('cursor license and provenance notice are bundled', async () => {
  for (const name of ['cursors/LICENSE', 'cursors/README.md']) {
