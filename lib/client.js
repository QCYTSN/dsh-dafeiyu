    ...
    return React.createElement('li', { style: cardStyle, 'data-testid': 'dsh-dafeiyu-settings' },
      ...
      status === 'unavailable'
        ...
        : React.createElement(React.Fragment, null,
          ...
          React.createElement(Field, { label: '显示状态气泡', hint: '关闭后只显示角色，不显示状态卡片。' },
            React.createElement('input', {
              type: 'checkbox', checked: value.showBubble !== false, disabled: !writable,
              onChange: (event) => void write('showBubble', event.target.checked),
            }),
          ),
